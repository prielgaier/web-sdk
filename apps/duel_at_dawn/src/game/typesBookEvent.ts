...
type BookEventFreegameMode = {
	index: number;
	type: 'freegameMode';
	mode: 'wild_wild_west' | 'dusk_til_dawn';
};
...
export type BookEvent =
	...
	// Duel At Dawn specific
	| BookEventVsDuel
	| BookEventOutlawFeature
	| BookEventFreegameMode
	// customised
	| BookEventCreateBonusSnapshot;
